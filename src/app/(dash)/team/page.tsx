    ...
    <>
      ...
      <div className="card" style={{ padding: "6px 8px", overflowX: "auto", marginBottom: 18 }}>
        <table className="tbl" style={{ minWidth: 900 }}>
          ...
          <tbody>
            {team.map((u) => (
              <TeamRow key={u.id} u={u} meId={me.id} meRole={me.role} />
            ))}
          </tbody>
        </table>
      </div>

      <AddPanel meRole={me.role} />
      ...
      <p style={{ color: "var(--muted)", fontSize: 12, marginTop: 16, maxWidth: 720 }}>
        ...
        the remaining active sales reps, keeping each lead&rsquo;s status, notes and history
